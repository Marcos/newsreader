...
public class TestNDEntries {
    ...
    final URL link1 = this.getClass().getClassLoader().getResource("nd-joinville-n1.htm");
    final URL link2 = this.getClass().getClassLoader().getResource("nd-joinville-n2.htm");
    ...
    public void beforeTest() throws IOException, ParserConfigurationException {
    	entryPattern = SourcePatternFactory.getNDJoinvillePattern();
    ...
    public void testReadLink1() throws MalformedURLException, LinkException{
    	...
    	Assert.assertNull(linkEntry.getText());
    	
    	String formatedText = linkEntry.getFormattedText();
    	Assert.assertNull(formatedText);
    	
    	String imgPath = linkEntry.getImgPath();
    	String expectedImg = "http://www.ndonline.com.br/uploads/global/materias/2013/05/22-05-2013-19-19-11-sss-2498.gif";
    ...
    public void testReadLink2() throws MalformedURLException, LinkException{
    	...
    	String imgPath = linkEntry.getImgPath();
    	String expectedImg = "http://www.ndonline.com.br/uploads/global/materias/2013/05/22-05-2013-11-01-50-reuniao-subprefeitura.jpg";
    	Assert.assertEquals(expectedImg, imgPath);
    }
}
