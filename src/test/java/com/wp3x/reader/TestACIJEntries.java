...
public class TestACIJEntries {
	...
	public void testGetLinks() throws Exception {
		...
		assertEquals("Revista 21", firstEntry.getTitle());
		assertEquals(null, firstEntry.getDate());
		assertEquals("/noticias/show/id/901%26", firstEntry.getUrl());
		assertEquals("http://www.acij.com.br/noticias/show/id/901%26",
