...
public class TestCVJoinvilleEntries {
	...
	final URL resource = this.getClass().getClassLoader()
			.getResource("cv-joinville-list.htm");
	final URL link1 = this.getClass().getClassLoader()
			.getResource("cv-joinville-n1.htm");
	final URL link2 = this.getClass().getClassLoader()
			.getResource("cv-joinville-n2.htm");
	...
	public void testGetLinks() throws Exception {
		...
		assertEquals("Legislativo na entrega de ordem de serviço",
				firstEntry.getTitle());
		assertEquals("2013-04-24", firstEntry.getDate());
		assertEquals(
				"/component/content/article/47-noticias/1821-legislativo-na-entrega-de-ordem-de-servico",
				firstEntry.getUrl());
		assertEquals(
				"http://www.cvj.sc.gov.br/component/content/article/47-noticias/1821-legislativo-na-entrega-de-ordem-de-servico",
				firstEntry.getFormattedURL());
		assertEquals(1366772400000L, firstEntry.getDateAsLong().longValue());
