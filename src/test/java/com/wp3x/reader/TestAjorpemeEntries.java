...
public class TestAjorpemeEntries {
	...
	public void testGetLinks() throws Exception {
		...
		assertEquals(
				...
				firstEntry.getTitle());
		assertEquals("18/04/13", firstEntry.getDate());
		assertEquals(
				"/site/noticias/1803-180413-esta-semana-tem-cafe-a-negocios-na-ajorpeme",
				firstEntry.getUrl());
		assertEquals("Esta semana tem Café & Negócios na Ajorpeme",
				firstEntry.getFormattedTitle());
		assertEquals(
				"http://ajorpeme.com.br/site/noticias/1803-180413-esta-semana-tem-cafe-a-negocios-na-ajorpeme",
