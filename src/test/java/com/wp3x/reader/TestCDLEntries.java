...
public class TestCDLEntries {
	...
	final URL resource = this.getClass().getClassLoader()
			.getResource("cdl-joinville-list.htm");
	final URL link1 = this.getClass().getClassLoader()
			.getResource("cdl-joinville-n1.htm");
	final URL link2 = this.getClass().getClassLoader()
			.getResource("cdl-joinville-n2.htm");
	...
	public void testGetLinks() throws Exception {
		...
		assertEquals("Curso: Oratória do Básico ao AvançadoObjetivos /",
				formattedTitle);
		assertEquals("noticia/13", firstEntry.getUrl());
		assertEquals("http://www.cdljoinville.com.br/noticia/13",
	...
	public void testReadLink1() throws Exception {
		...
		assertEquals(getExpectedFormattedLinkText1(), formattedText);
	}
