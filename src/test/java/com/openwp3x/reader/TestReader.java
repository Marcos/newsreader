...
public class TestReader {
	...
	final URL resource2 = this.getClass().getClassLoader().getResource("defesa-civil-n1.htm");
    Reader newsReader1;
    Reader newsReader2;

    @Before
    public void beforeTest() throws Throwable{
    	SourcePattern entryPattern1 = SourcePatternFactory.getUdescPattern();
    	entryPattern1.setSourceURL(resource1);
        this.newsReader1 = new Reader(resource1, entryPattern1.getSource(), entryPattern1.getSourceType(), entryPattern1.getCharset());
        
        SourcePattern entryPattern2 = SourcePatternFactory.getDefesaCivilPattern();
    	entryPattern2.setSourceURL(resource2);
        this.newsReader2 = new Reader(resource2, entryPattern1.getSource(), entryPattern1.getSourceType(), entryPattern1.getCharset());
    }
